      ...
      return {
        meta: [
          { hid: "og:type", property: "og:type", contnet: "website" },
          {
            ...
            contnet: "Nuxt Movie App",
          },
          {
            hid: "og:title",
            property: "og:title",
            contnet: this.theMovie.Title,
          },
          {
            hid: "og:description",
            property: "og:description",
            contnet: this.theMovie.Plot,
          },
          {
            hid: "og:image",
            property: "og:image",
            contnet: this.theMovie.Poster,
          },
          {
            hid: "og:url",
            property: "og:url",
            contnet: `${process.env.CLIENT_URL}${this.$route.fullPath}`,
          },
        ],
      };
    },
