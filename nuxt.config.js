export default {
  ...
  head: {
    ...
    meta: [
      ...
      { 'htt-equiv' : 'X-UA-Compatible', content:"IE=edge"},
      ...
      { hid : 'og:site_name', property : 'og:site_name', contnet : 'Nuxt Movie App'},
      { hid : 'og:title', property : 'og:title', contnet : 'Nuxt Movie App / Search'},
      { hid : 'og:description', property : 'og:description', contnet : 'The OMDb API is a RESTful web service to obtain movie information, all content and images on the site are contributed and maintained by our users.'},
      { hid : 'og:image', property : 'og:image', contnet : 'https://heropy.blog/css/images/logo.png'},
      { hid : 'og:url', property : 'og:url', contnet : process.env.CLIENT_URL},
